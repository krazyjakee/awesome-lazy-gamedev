# Awesome Lazy Gamedev

A curated list of good stuff related to automating the development of games. This list contains _only_ [free software][1] for code, sellers who aren't evil for physical resources, and [free cultural works][2] for assets.

I have also provided a list of resources which are _not_ free, and the reasons why, in the associated Wall of Shame file.
...
- [Awesome Lazy Gamedev](#awesome-lazy-gamedev)
  ...
  - [Asset Generators](#asset-generators)
    ...
    - [Sound Effect Generators](#sound-effect-generators)
    - [3D Model Generators](#3d-model-generators)
    - [Concept Art Generators](#concept-art-generators)
    - [Texture Generators](#texture-generators)
    - [Normal/Heightmap Generators](#normalheightmap-generators)
...
- [Quaternius][434] - A collection of low poly 3D models.
...
- [Aiva][433] - A service to generate music

### Sound Effect Generators

- [Clip.Audio][432] - A service to search for and generate sound effects.
